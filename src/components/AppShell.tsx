...
export function AppShell({ left, center, right, status }: AppShellProps) {
  return (
    <div className="min-h-screen bg-slate-950 p-4 text-slate-100">
      <header className="mb-4 flex items-center justify-between rounded-lg border border-slate-800 bg-slate-900 px-4 py-3">
        <div>
      ...
      <main className="grid gap-4 xl:grid-cols-[1.05fr_1fr_1fr]">
